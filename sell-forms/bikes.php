        ...
        <div class="container">
            ...
            <form action="upload.php" id="sform" method="POST" enctype="multipart/form-data" name="form">
                <div class="row col-sm-10 col-xs-12 form">
                    ...
                    <label for="brand-name" class="req">Brand Name : </label><br>
                    <input type="text" id="brand-name" name="brand" maxlength="60" required min="3">
                    <p>(if there is no brand mention its Keyfeatures)</p><br>
                    ...
                    <p>(Must Include Condition, Features..etc of your product,<br>if possible also include Date of Purchase)</p><br>
                    ...
                    <input type="text" id="insta" name="insta" autocomplete="off"><input type="text" value="bikes" style="display:none;" id="cat" name="cat"> <br><br>
                    ...
                    <hr>
                    <label for="motivation"><small>Any Extra Comments from you to your buyers for this product?</small></label><br><input type="text" name="moti" id="moti">
