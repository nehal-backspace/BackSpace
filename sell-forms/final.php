...
$error=0;
///////////////////MUST BE CHANGED
//$newfile= "C:\wamp64\www\Project\\registeration\".$buid."/".$picname;
$newfile= $_SERVER['DOCUMENT_ROOT'] ."/registeration/user_files/".$buid."/".$picname;
//$finalfile="C:\wamp64\www\Project/buy/".$picname;
...
if($order=="*******"){
    ...
    if($error==0 && rename ($source,$finalfile)){
        ...
        if($response==""){
			   header("Location:http://backspace.ind.in/sell-forms/abc.php");
			} else{
			    return false;
			}
